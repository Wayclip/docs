...
<Callout>You usually don’t need to change these unless you are running multiple instances.</Callout>
...
<Callout title='Workflow Tip'>
    With these settings, you can fine-tune how Wayclip captures, names, and saves your clips while controlling audio and
    shortcuts to match your workflow.
</Callout>


#### Very sorry, this is AI generated as a filler text (I promise I will update it)
