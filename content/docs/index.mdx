...
- **wayclip_gui** _(coming soon)_ — a Tauri-based desktop application (under active development, optimized for Wayland).
...
- **wayclip_dash** _(coming soon)_ — a web dashboard for managing your account, billing and more.
