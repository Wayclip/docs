...
import { type BaseLayoutProps, BaseLinkItem, getLinks, type IconItemType, type LinkItemType } from '../shared/index';
            ...
            <NavProvider transparentMode={transparentMode}>
                ...
                <LayoutBody
                    ...
                    className={cn(
                        ...
                        !nav.component && nav.enabled !== false && '[--fd-nav-height:56px] md:[--fd-nav-height:0px]',
